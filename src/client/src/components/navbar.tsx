            ...
            <div className="flex justify-between items-center max-w-4xl w-full">
                ...
                <ul className="flex items-center">
                    ...
                    <li className="p-2 mr-3 relative">
						...
						<ul className={`fixed w-full top-[40px] mt-3 right-0 bg-white p-2 shadow sm:w-auto sm:overflow-hidden sm:rounded-sm dark:bg-neutral-900 ${!accountDropDown && 'hidden'}`}>
							<li>
